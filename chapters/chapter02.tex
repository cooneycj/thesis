...
\begin{tabular}{lll}
{\bf (i)} & {\bf (ii)} & {\bf (iii)} \\
\resizebox{0.3\textwidth}{!}{\input{images/IMI1}} & \resizebox{0.3\textwidth}{!}{\input{images/IMI3}} & \resizebox{0.3\textwidth}{!}{\input{images/IMI5}} \\ 
{\bf (iv)} & {\bf (v)} & {\bf (vi)} \\
\resizebox{0.3\textwidth}{!}{\input{images/IMI7}} & \resizebox{0.3\textwidth}{!}{\input{images/IMI9}} & \resizebox{0.3\textwidth}{!}{\input{images/IMI11}} \\ 
{\bf (vii)} & {\bf (viii)} & {\bf (ix)} \\
\resizebox{0.3\textwidth}{!}{\input{images/IMI13}} & \resizebox{0.3\textwidth}{!}{\input{images/IMI15}} & \resizebox{0.3\textwidth}{!}{\input{images/IMI17}} 
\end{tabular}
\bigskip
\rule{33em}{0.5pt}
